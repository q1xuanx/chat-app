...
public class storeMsgModels {
    ...
    public int storeMsgGroup(String idchat, String username, String msg, String timesend) throws ClassNotFoundException, SQLException{
        db = new DBAccess();
        String q = "exec storeMsgGroup '"+idchat+"','"+username+"','"+msg+"','"+timesend+"'";
