...
public class ServerControls {
    ...
    public ServerControls() throws IOException {
        ...
        while (true) {
            ...
            System.out.println(username + " has login to server");
    ...
    public ServerControls(String username){
        
    }
    public DefaultListModel getUserInMap(String username){
        DefaultListModel t = new DefaultListModel();
        for (Map.Entry<String, Socket> m : mp.entrySet()){
            if (m.getKey() != username){
                t.addElement(m.getKey());
            }
        }
        return t;
    }
